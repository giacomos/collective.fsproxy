...
def setup_product():
    ...
    import collective.fsproxy
    zcml.load_config('configure.zcml', collective.fsproxy)
    ...
    ztc.installPackage('collective.fsproxy')
...
setup_product()
ptc.setupPloneSite(products=['collective.fsproxy'])
